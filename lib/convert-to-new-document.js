...
module.exports = document => {
  ...
  return {
    ...
    variant: document.documentCategory, // TODO: some of these have changed names?
    student: {
    ...
    isEncrypted: (document.documentType === 'notat' ? true : false), // this doesn't exist in the old document schems?!
